    ...
    return (
      <div className={`${styles.modalBackground} ${styles.displayBlock}`} >
        <div className={styles.modalMain}>
          <button onClick={() => this.props.previousClick()} className={`${styles.button} ${styles.arrow}`}>
          ...
          <InnerImageZoom src={this.props.link} className={styles.modalDisplay}/>
          <button onClick={() => this.props.nextClick()} className={`${styles.button} ${styles.arrow}`}>
          ...
          <ModalImageList link={this.props.link} links={this.props.links} click={this.props.imageClick}/>
        </div>
